...
<html>
	<head>
		...
		<meta description="Info lõunasöökide kohta tartus." />
		<link href="styles.css?20" rel="stylesheet" type="text/css"/>
		...
		<div class="main">
			...
			<div class="float_container">
				<div class="header_text">
					...
					<h2 class="header_info">
						Tänased päevapakkumised	Tartu kesklinna söögikohtades
					</h2>
					<div class="clear_float"></div>
				</div>
			...
			<div class="main_body">
				<div class="like_button">
					<script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like href="http://www.facebook.com/pages/Tartu-Paevapraed/179457692076223" layout="button_count" show_faces="false" width="450"></fb:like>
				</div>
					...
					<div class="content_center" id="nonfavorites">
						<div class="float_container">
							<div class="float_left">
								...
								<p class="content_info_small_inline">Kinohvik, Rebase söögituba, Spordibaas, Trehv</p>
							</div>
							<div class="clear_float"></div>
						</div>
