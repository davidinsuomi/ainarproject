...
public class AppModule
{
    public static void bind(ServiceBinder binder)
    {
    	...
    	binder.bind(Pointful.class, PointfulImpl.class);
    ...
    /*
    public static void advisePointlessness(MethodAdviceReceiver receiver){
    ...
    */
    ...
    public static <T> T decoratePointlessness(Class<T> serviceInterface, T delegate,
    		String serviceId, PointlessDecorator decorator){
